  ...
  if (isLoading) {
    return (
      <div className="fixed inset-0 bg-black/30 backdrop-blur-sm z-50 flex items-center justify-center">
        <div className="bg-white/80 backdrop-blur p-8 rounded-2xl shadow-xl border border-gray-100 flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            <span className="text-sm text-gray-500">لطفا صبر کنید...</span>
          </div>
        </div>
      </div>
    );
    ...
    if (id) {
      ...
      verify(
        { id, data: { self_status: "rejected" } },
        {
          ...
          onError: () => {
            toast.error("خطایی در رد کردن رخ داده است");
            refetch();
          },
          onSettled: () => {
            setLoadingId(null);
                      ...
                      .map((item: VerifyType, index: number) => (
                        ...
                        >
                          ...
                          <div className="flex gap-2 w-full sm:w-auto justify-end sm:justify-start">
                            <button
                              className="flex-1 sm:flex-none px-3 sm:px-5 py-2 text-xs sm:text-sm font-medium bg-green-50 text-green-600 rounded-lg hover:bg-green-100 transition-all duration-300 flex items-center justify-center gap-1 sm:gap-2 hover:shadow-lg hover:shadow-green-100 disabled:opacity-50 disabled:cursor-not-allowed"
