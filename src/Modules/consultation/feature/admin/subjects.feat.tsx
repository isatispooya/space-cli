...
import { AdminSubjectType } from "../../types";

const categories = [...new Set(subjects.map((subject) => subject.category))];

interface AdminConsultationSubjectsProps {
  onSelect: (subject: AdminSubjectType) => void;
}

export const AdminConsultationSubjects = ({
  onSelect,
}: AdminConsultationSubjectsProps) => {
    ...
    >
      ...
      >
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
          لطفا مشاور مرتبط را اختصاص دهید
        </h1>
...
export default AdminConsultationSubjects;
