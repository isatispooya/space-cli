...
import { AdminConsultationSubjects } from "./index";
import type { AdminSubjectType } from "../../types";

export const AdminConsultationFlow = () => {
  const [selectedSubject, setSelectedSubject] =
    useState<AdminSubjectType | null>(null);

  const handleSubjectSelect = (subject: AdminSubjectType) => {
      ...
      <AnimatePresence mode="wait">
        {!selectedSubject ? (
          ...
          <motion.div
            ...
            exit={{ opacity: 0, x: -20 }}
          >
            <AdminConsultationSubjects
              onSelect={(subject: AdminSubjectType) =>
...
export default AdminConsultationFlow;
