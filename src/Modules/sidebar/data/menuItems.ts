...
export const menuItems: MenuItem[] = [
  {
    ...
    submenu: [
      { title: "پروفایل", path: "/profile", codename: "user_profile" },
      {
        ...
        submenu: [
          { title: "تنظیمات حساب", path: "/settings/account", codename: "account_settings" },
          { title: "تنظیمات امنیتی", path: "/settings/security", codename: "security_settings" },
        ],
      },
    ],
  },
    ...
    submenu: [
      { title: "لیست سهامداران", path: "/shareholders/table", codename: "view_shareholders" },
      {
        ...
        submenu: [
          ...
          { title: "ویرایش سهامدار", path: "/shareholders/update", codename: "update_shareholders" },
      ...
      },
      {
        ...
        submenu: [
          { title: "لیست سود پرداختی", path: "/capital/table", codename: "paid_profit_list" },
          { title: "ایجاد سود پرداختی", path: "/capital/create", codename: "create_paid_profit" },
        ],
      },
      {
        title: "حق تقدم",
      ...
      },
      {
        ...
        submenu: [
          { title: "لیست حق تقدم خرید", path: "/purchacePrecendence/table", codename: "purchase_precedence_list" },
          { title: "ایجاد حق تقدم خرید", path: "/purchacePrecendence/create", codename: "create_purchase_precedence" },
        ],
      },
    ],
  },
  {
    ...
    submenu: [
      { title: "لیست شرکت‌ها", path: "/companies/table", codename: "companies_list" },
      { title: "افزودن شرکت", path: "/companies/create", codename: "create_company" },
    ],
  },
  {
    title: "مکاتبات",
    ...
    submenu: [
      { title: "لیست مکاتبات", path: "/correspondence/table", codename: "correspondence_list" },
      { title: "ایجاد مکاتبه", path: "/correspondence/create", codename: "create_correspondence" },
    ],
  },
  {
    title: "مدیریت نقش‌ها",
    ...
    submenu: [
      ...
      { title: "ایجاد نقش", path: "/positions/create", codename: "create_role" },
    ],
  },
  {
    title: "تماس",
  ...
  },
  {
    ...
    submenu: [
      { title: "لیست دسترسی ها", path: "/permissions/table", codename: "permissions_list" },
      { title: "ایجاد,ویرایش دسترسی ها", path: "/permissions/create", codename: "manage_permissions" },
    ],
  },
  {
    title: "گروه ها",
