          ...
          <div className="prose prose-lg max-w-4xl mx-auto text-right space-y-6">
            <div className="bg-blue-50 p-6 rounded-lg">
              <p className="text-gray-700 leading-relaxed mb-4">
                با افتخار اعلام می‌کنیم که باشگاه مشتریان صنایع مفتول ایساتیس
            ...
            <div className="bg-yellow-50 p-6 rounded-lg">
              ...
              <ol className="list-decimal list-inside space-y-2">
                <li>
                  از طریق لینک ثبت‌نام در باشگاه مشتریان، پروفایل خود را بسازید
                </li>
            ...
            <div className="bg-purple-50 p-6 rounded-lg">
              ...
              <p>
                شما عزیزان می‌توانید امتیازات دریافتی در باشگاه مشتریان خود را
                در امور خیریه (طبق لیست پیشنهادی در باشگاه مشتریان) صرف نمایید.
              </p>
            </div>
            ...
            <div className="bg-indigo-50 p-6 rounded-lg">
              ...
              <p>
                باشگاه مشتریان صنایع مفتول ایساتیس پویا، فرصتی است برای رشد،
