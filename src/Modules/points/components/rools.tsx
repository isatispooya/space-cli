            ...
            >
                ...
                <motion.div className="flex flex-col items-center space-y-8">
                    <h1 className="text-3xl font-bold text-[#5677BC] mb-6">
                        باشگاه مشتریان صنایع مفتول ایساتیس پویا
                    </h1>
                    
                    <div className="prose prose-lg max-w-4xl mx-auto text-right space-y-6">
                        <div className="bg-blue-50 p-6 rounded-lg">
                            <p className="text-gray-700 leading-relaxed mb-4">
                                با افتخار اعلام می‌کنیم که باشگاه مشتریان صنایع مفتول ایساتیس پویا، با هدف ایجاد ارزش بیشتر برای سهام‌داران و همراهان گرامی، آغاز به کار کرده است. این باشگاه فرصتی ویژه است تا شما، به‌عنوان یکی از اعضای خانواده ایساتیس پویا، از امکانات و مزایای منحصر‌به‌فرد آن بهره‌مند شوید.
                            </p>
                        </div>
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <h3 className="font-bold mb-2">۱. کسب امتیاز از فعالیت‌های مختلف:</h3>
                                ...
                                <div>
                                    ...
                                    <p>امتیازات کسب‌شده را می‌توانید به سهام شرکت تبدیل کنید یا از جوایز جذاب دیگر بهره‌مند شوید</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-yellow-50 p-6 rounded-lg">
                            ...
                            <ol className="list-decimal list-inside space-y-2">
                                <li>از طریق لینک ثبت‌نام در باشگاه مشتریان، پروفایل خود را بسازید</li>
                                <li>کد معرف شخصی خود را دریافت کنید</li>
                                <li>دوستان و آشنایان خود را معرفی کنید</li>
                                <li>با فعالیت بیشتر، امتیاز کسب کنید و به سطوح بالاتر دست یابید</li>
                            </ol>
                        </div>
                        ...
                        <div className="bg-purple-50 p-6 rounded-lg">
                            ...
                            <p>
                                شما عزیزان می‌توانید امتیازات دریافتی در باشگاه مشتریان خود را در امور خیریه (طبق لیست پیشنهادی در باشگاه مشتریان) صرف نمایید.
                            </p>
                        </div>
                        ...
                        <div className="bg-indigo-50 p-6 rounded-lg">
                            ...
                            <p>
                                باشگاه مشتریان صنایع مفتول ایساتیس پویا، فرصتی است برای رشد، موفقیت و سرمایه‌گذاری پایدار. همین امروز عضو شوید و همراه ما در این مسیر هیجان‌انگیز باشید.
                            </p>
                        </div>
                    </div>
                </motion.div>
